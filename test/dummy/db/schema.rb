...
ActiveRecord::Schema.define(:version => 20130219032932) do
  ...
  add_index "food_ndb_data_sources", ["id"], :name => "index_food_ndb_data_sources_on_id", :unique => true
  ...
  add_index "food_ndb_derivations", ["code"], :name => "index_food_ndb_derivations_on_code", :unique => true
  ...
  add_index "food_ndb_food_groups", ["code"], :name => "index_food_ndb_food_groups_on_code", :unique => true
  ...
  add_index "food_ndb_food_nutrients", ["derivation_code"], :name => "index_food_ndb_food_nutrients_on_derivation_code"
  add_index "food_ndb_food_nutrients", ["nutrient_databank_number", "nutrient_number"], :name => "by_food_and_nutrient"
  add_index "food_ndb_food_nutrients", ["source_code"], :name => "index_food_ndb_food_nutrients_on_source_code"
  ...
  add_index "food_ndb_food_nutrients_data_sources", ["nutrient_databank_number", "nutrient_number", "data_source_id"], :name => "by_food_nutrient_and_data_source"
  ...
  add_index "food_ndb_foods", ["food_group_code"], :name => "index_food_ndb_foods_on_food_group_code"
  add_index "food_ndb_foods", ["nutrient_databank_number"], :name => "index_food_ndb_foods_on_nutrient_databank_number", :unique => true
  ...
  add_index "food_ndb_foods_languals", ["nutrient_databank_number", "langual_code"], :name => "by_ndbn_and_langual", :unique => true
  ...
  add_index "food_ndb_footnotes", ["nutrient_databank_number", "sequence", "type"], :name => "by_food_sequence_and_type"
  ...
  add_index "food_ndb_languals", ["code"], :name => "index_food_ndb_languals_on_code", :unique => true
  ...
  add_index "food_ndb_nutrients", ["number"], :name => "index_food_ndb_nutrients_on_number", :unique => true
  ...
  add_index "food_ndb_sources", ["code"], :name => "index_food_ndb_sources_on_code", :unique => true
  ...
  add_index "food_ndb_weights", ["nutrient_databank_number", "sequence"], :name => "index_food_ndb_weights_on_nutrient_databank_number_and_sequence"
